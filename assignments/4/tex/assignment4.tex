...
\autoref{tab:segvaf}. The measured and estimated rotation using a model with
...
Measured input and output data was detrended before calculation of VAF and
plotting.
\begin{table}
    \centering
    \begin{tabular}{|l|r|r|r|r|r|r|}
...
We want to use high-pass filters to remove low frequency content. We expect
human reflexes to by high frequency and changes due to fatigue or distraction
to low frequency.
...
measured and estimated output as the error results in the estimated parameters
in \autoref{tab:segparamtd}.
...
\begin{table}
    ...
    \begin{tabular}{|l|r|r|r|r|r|r|}
        ...
        \hline
    \end{tabular}
    \caption{Estimated Parameters from Wrist with Velocity Feedback Model with
        Time Domain Optimization}
    \label{tab:segparamtd}
\end{table}

% 2n
\subsection{Comparison of Frequency and Time Domain Estimates}
VAF and SEM using time domain optmization in \autoref{tab:segvaftdhp} and
\autoref{tab:segsemtdhp}.
...
\begin{table}
    ...
    \begin{tabular}{|l|r|r|r|r|r|r|}
        ...
        \nonumber & segment 1 & segment 2 & segment 3 & segment 4 \\
        \hline
        VAF & $93.9951$ & $95.4617$ & $94.8857$ & $97.4736$ \\
        \hline
    \end{tabular}
    \caption{VAF for Wrist with Velocity Feedback Model for Time Domain
        Optimization and High Pass Filtering}
    \label{tab:segvaftdhp}
\end{table}
...
\begin{table}
    ...
    \begin{tabular}{|l|r|r|r|r|r|r|}
        ...
        \nonumber & segment 1 & segment 2 & segment 3 & segment 4 \\
        \hline
        $M$ [kg] & $0.0000$ & $0.0000$ & $0.0001$ & $0.0001$ \\
        $B$ [N\,s/m] & $0.0005$ & $0.0005$ & $0.0006$ & $0.0007$ \\
        $K$ [N/m] & $0.0123$ & $0.0110$ & $0.0165$ & $0.0188$ \\
        $K_v$ [rad/s] & $0.0011$ & $0.0012$ & $0.0029$ & $0.0041$ \\
        $t_d$ [s] & $0.0004$ & $0.0004$ & $0.0007$ & $0.0011$ \\
        $w$ [rad/s] & $0.2817$ & $0.2771$ & $0.4552$ & $0.6427$ \\
        \hline
    \end{tabular}
    \caption{SEM of Estimated Parameters from Wrist with Velocity Feedback
        Model for Time Domain Estimation and High Pass Filtering}
    \label{tab:segsemtdhp}
\end{table}
...
\begin{table}
    ...
    \begin{tabular}{|l|r|r|r|r|r|r|}
        ...
        \nonumber & segment 1 & segment 2 & segment 3 & segment 4 \\
        \hline
        $M$ [kg] & $0.0030$ & $0.0029$ & $0.0026$ & $0.0023$ \\
        $B$ [N\,s/m] & $0.0371$ & $0.0408$ & $0.0595$ & $0.0670$ \\
        $K$ [N/m] & $4.9675$ & $5.3029$ & $6.1462$ & $6.5311$ \\
        $K_v$ [rad/s] & $-0.0782$ & $-0.0775$ & $-0.0659$ & $-0.0660$ \\
        $t_d$ [s] & $0.0400$ & $0.0398$ & $0.0471$ & $0.0507$ \\
        $w$ [rad/s] & $28.3671$ & $28.8176$ & $23.1918$ & $19.4152$ \\
        \hline
    \end{tabular}
    \caption{Estimated Parameters from Wrist with Velocity Feedback Model for
        Time Domain Estimation and High Pass Filtering}
    \label{tab:segparamtdhp}
\end{table}
